...
function signal_to_pressure_level(mapping::SignalPressureMapping, X::Array{Float64})::Array{Float64}
	return 20 .* log10.(abs.(X)) .+ mapping.offset_db
end

function pressure_to_signal_level(mapping::SignalPressureMapping, X::Array{Float64})::Array{Float64}
