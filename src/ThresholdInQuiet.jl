...
function threshold_in_quiet_pressure_level(frequencies::Array{Float64})::Array{Float64}
...
function threshold_in_quiet_signal_level(mapping::SignalPressureMapping, frequencies::Array{Float64})::Array{Float64}
    threshold::Array{Float64} = threshold_in_quiet_pressure_level(frequencies)
    return pressure_to_signal_level(mapping, threshold)
end